...
def run_network():
    ...
    net = fb.Network(hidden_nos=15, cache_len=15, replace_anomalies=True)
    net.SGD(eta=0.25, mu=0.0, mini_batch_size=10, epochs=20, eta_steps=12, monitor_session=True)
